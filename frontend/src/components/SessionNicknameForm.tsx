  ...
  return (
    <form onSubmit={onSubmit} className="w-96 flex flex-col gap-4 bg-primary-900 p-4 rounded-2xl">
      ...
      <div className="flex gap-2">
        <input ref={input} maxLength={20} className="w-full h-10 px-4 py-2 rounded-full bg-background-100 text-text-900 dark:bg-primary-800 dark:text-text-50" placeholder="Sketch Queen..." />
