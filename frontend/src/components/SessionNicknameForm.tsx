...
export function SessionNicknameForm() {
  ...
  return (
    <div className="w-fit grid gap-8">
      <form
        onSubmit={onSubmit}
        className="w-full max-w-md flex flex-col gap-4 text-text-900 dark:text-text-50 bg-purple-50 dark:bg-primary-900 p-8 rounded-2xl dark:border dark:border-primary-500 shadow-md dark:shadow-primary-500">
        ...
        <div className="grid gap-2">
          ...
          <div className="flex text-lg w-full px-4 py-2 rounded-2xl bg-primary-100/40 dark:bg-primary-800/60 text-text-950 dark:text-text-50 border border-primary-500">
            <input
              id="name"
              name="name"
              type="text"
              placeholder="Sketch Queen..."
        ...
        <div className="flex items-center gap-2 mb-4 text-text-900 dark:text-text-100">
          ...
          <p className="text-sm">You always can change this later</p>
        </div>

        <button
          type="submit"
          className="mb-4 text-xl p-3 rounded-2xl bg-primary-500 font-bold text-text-50 border border-primary-500 hover:scale-105 active:scale-100 duration-125 cursor-pointer">
          Let's play
        </button>
      </form>
    </div>
