...
export function ChatInput() {
  ...
  return (
    <form onSubmit={onSubmit} className={`${keyboardOpen ? "fixed bottom-[45%] left-0 right-0" : "bottom-[2%]"} w-full md:static flex items-center justify-between gap-2`}>
      ...
      <button onMouseDown={ev => { ev.preventDefault() }} className="shrink-0 bg-primary-500 dark:bg-primary-700 p-4 rounded-full text-text-50 hover:scale-110 active:scale-100 duration-150">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M21.864 3.549l-6.454 17.868a1.55 1.55 0 0 1 -1.41 .903a1.54 1.54 0 0 1 -1.394 -.874l-2.88 -5.759zm-1.414 -1.414l-12.139 12.138l-5.728 -2.864a1.55 1.55 0 0 1 -.903 -1.409c0 -.606 .353 -1.157 .981 -1.44z" /></svg>
      </button>
    </form>
